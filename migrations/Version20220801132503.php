...
final class Version20220801132503 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE country (id INT AUTO_INCREMENT NOT NULL, nationality VARCHAR(128) NOT NULL, url_flag VARCHAR(255) DEFAULT NULL, code VARCHAR(2) NOT NULL, name VARCHAR(180) NOT NULL, slug VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_5373C9665E237E06 (name), UNIQUE INDEX UNIQ_5373C966989D9B62 (slug), PRIMARY KEY(id)) ENGINE = InnoDB');
        $this->addSql('CREATE TABLE game (id INT AUTO_INCREMENT NOT NULL, publisher_id INT DEFAULT NULL, price DOUBLE PRECISION NOT NULL, published_at DATETIME NOT NULL, description LONGTEXT NOT NULL, thumbnail_cover VARCHAR(255) DEFAULT NULL, thumbnail_logo VARCHAR(255) DEFAULT NULL, name VARCHAR(180) NOT NULL, slug VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_232B318C5E237E06 (name), UNIQUE INDEX UNIQ_232B318C989D9B62 (slug), INDEX IDX_232B318C40C86FCE (publisher_id), PRIMARY KEY(id)) ENGINE = InnoDB');
        $this->addSql('CREATE TABLE game_country (game_id INT NOT NULL, country_id INT NOT NULL, INDEX IDX_C6B1B649E48FD905 (game_id), INDEX IDX_C6B1B649F92F3E70 (country_id), PRIMARY KEY(game_id, country_id)) ENGINE = InnoDB');
        $this->addSql('CREATE TABLE game_genre (game_id INT NOT NULL, genre_id INT NOT NULL, INDEX IDX_B1634A77E48FD905 (game_id), INDEX IDX_B1634A774296D31F (genre_id), PRIMARY KEY(game_id, genre_id)) ENGINE = InnoDB');
        $this->addSql('CREATE TABLE genre (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(180) NOT NULL, slug VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_835033F85E237E06 (name), UNIQUE INDEX UNIQ_835033F8989D9B62 (slug), PRIMARY KEY(id)) ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE publisher (id INT AUTO_INCREMENT NOT NULL, country_id INT DEFAULT NULL, website VARCHAR(180) NOT NULL, created_at DATETIME NOT NULL, name VARCHAR(180) NOT NULL, slug VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_9CE8D5465E237E06 (name), UNIQUE INDEX UNIQ_9CE8D546989D9B62 (slug), INDEX IDX_9CE8D546F92F3E70 (country_id), PRIMARY KEY(id)) ENGINE = InnoDB');
